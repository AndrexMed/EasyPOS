...
{
    public class EasyPOSProblemDetailFactory : ProblemDetailsFactory
    {
        private readonly ApiBehaviorOptions _behaviorOptions;

        public EasyPOSProblemDetailFactory(ApiBehaviorOptions behaviorOptions)
        {
            _behaviorOptions = behaviorOptions ?? throw new ArgumentNullException(nameof(behaviorOptions));
        }
        ...
        {
            statusCode ??= 500; //Si status es nullo lo iguale a 500
